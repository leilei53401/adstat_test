...
public class ThreadPool {
	...
	public void initThreadPool(int queueSize, int keepAliveTime, int maxPoolSize, int corePoolSize){
		if(threadPool == null){
			...
			//修改为阻塞模式
			threadPool = new  ThreadPoolExecutor(corePoolSize, maxPoolSize, keepAliveTime, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(queueSize),	new DefaultThreadFactory(),	new CustomRejectedExecutionHandler());
		}
	}
